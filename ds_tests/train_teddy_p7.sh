...
python3.9 main.py -O --image /mnt/cache_sail/liulj/stable-dreamfusion/data/teddy_rgba.png \
        --workspace dreamscene/teddy_phrase1_param7 --iters 10000 --dreamscene --posefile "" \
        --dreamscene_ckpt /home/liulj/latest.ckpt --save_guidance --save_guidance_interval 50 \
        --ckpt scratch --batch_size 1 --h 96 --w 96 --fovy_range 20 20 --default_fovy 20 --guidance_scale 10 \
        --lambda_3d_normal_smooth 10 --dont_override_stuff --test_interval 10 \
        --default_radius 3.2 --radius_range 3.2 3.6 --optim adam --lr 0.0008 --dataset_size_train 300 
