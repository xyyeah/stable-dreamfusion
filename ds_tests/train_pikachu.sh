...
# # Phase 1
python3.9 main.py -O --image /mnt/cache_sail/liulj/stable-dreamfusion/ds_tests/pikachu_01_rgba.png \
        --workspace dreamscene/pikachu_phrase1_param1 --iters 10000 --dreamscene --posefile "" \
        --dreamscene_ckpt /home/liulj/latest.ckpt --save_guidance --save_guidance_interval 10 --test_interval 2 \
        --ckpt scratch --batch_size 1 --h 128 --w 128 --fovy_range 19 19 --default_fovy 19 --guidance_scale 50 \
...
python3.9 main.py -O --image /mnt/cache_sail/liulj/stable-dreamfusion/ds_tests/pikachu_01_rgba.png \
        --workspace dreamscene/pikachu_phrase2_param1 --text "a DSLR image of a cute pikachu with short hand and big tail stand on the ground " \
        --iters 12500 --ckpt dreamscene/pikachu_phrase1_param1/checkpoints/df_ep0100.pth --save_guidance --save_guidance_interval 1 \
        --h 256 --w 256 --albedo_iter_ratio 0.0 --t_range 0.2 0.6 --batch_size 1 --radius_range 2.2 2.6 --test_interval 2 \
...
# Phase 3
python3.9 main.py -O --image /mnt/cache_sail/liulj/stable-dreamfusion/ds_tests/pikachu_01_rgba.png \
        --workspace dreamscene/pikachu_phrase3_param1 --text "a DSLR image of a cute pikachu with short hand and big tail stand on the ground" \
        --iters 25000 --ckpt dreamscene/pikachu_phrase2_param1/checkpoints/df_ep0125.pth  --save_guidance --save_guidance_interval 1 \
