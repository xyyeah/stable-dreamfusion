...
#         --workspace dreamscene/teddy_phrase1 --iters 10000 --dreamscene --posefile "" \
#         --dreamscene_ckpt /home/liulj/latest.ckpt --save_guidance --save_guidance_interval 10 \
#         --ckpt scratch --batch_size 1 --h 128 --w 128
...
# python3.9 main.py -O --image /mnt/cache_sail/liulj/stable-dreamfusion/data/teddy_rgba.png \
#         --workspace dreamscene/teddy_phrase2 --text "a brown teddy bear sitting on a ground" \
#         --iters 12500 --ckpt dreamscene/teddy_phrase1/checkpoints/df_ep0100.pth --save_guidance --save_guidance_interval 1 \
...
# Phase 3
python3.9 main.py -O --image /mnt/cache_sail/liulj/stable-dreamfusion/data/teddy_rgba.png \
        --workspace dreamscene/teddy_phrase3 --text "a brown teddy bear sitting on a ground" \
        --iters 25000 --ckpt dreamscene/teddy_phrase2/checkpoints/df_ep0125.pth  --save_guidance --save_guidance_interval 1 \
        --h 128 --w 128 --albedo_iter_ratio 0.0 --t_range 0.0 0.5 --batch_size 1 --radius_range 3.2 3.6 --test_interval 2 \
