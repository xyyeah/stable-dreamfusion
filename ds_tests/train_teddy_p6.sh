...
#         --workspace dreamscene/teddy_phrase1_param6 --iters 10000 --dreamscene --posefile "" \
#         --dreamscene_ckpt /home/liulj/latest.ckpt --save_guidance --save_guidance_interval 50 \
#         --ckpt scratch --batch_size 1 --h 128 --w 128 --fovy_range 20 20 --default_fovy 20 --guidance_scale 10 \
#         --lambda_3d_normal_smooth 5 --dont_override_stuff --test_interval 2 \
#         --default_radius 3.2 --radius_range 3.2 3.6 --optim adam --lr 0.0001 --seed 33 --dataset_size_train 200
...
python3.9 main.py -O --image /mnt/cache_sail/liulj/stable-dreamfusion/data/teddy_rgba.png \
        --workspace dreamscene/teddy_phrase2_param6 --text "a brown teddy bear sitting on a ground" \
        --iters 15000 --ckpt dreamscene/teddy_phrase1_param6/checkpoints/df_ep0050.pth --save_guidance --save_guidance_interval 1 \
        --h 128 --w 128 --albedo_iter_ratio 0.0 --t_range 0.2 0.6 --batch_size 1 --radius_range 2.2 2.6 --test_interval 2 \
        --vram_O --guidance_scale 100 --jitter_pose --jitter_center 0.1 --jitter_target 0.1 --jitter_up 0.05 \
        ...
        --exp_start_iter 10000 --exp_end_iter 12500 --optim adam --lr 0.001 --dataset_size_train 200
