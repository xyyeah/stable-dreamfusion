...
python3.9 main.py -O --image /mnt/cache_sail/liulj/stable-dreamfusion/data/teddy_rgba.png \
        --workspace dreamscene/teddy_phrase1_param10 --iters 20000 --dreamscene --posefile "" \
        --dreamscene_ckpt /home/liulj/latest.ckpt --save_guidance --save_guidance_interval 50 \
        --ckpt scratch --batch_size 1 --h 128 --w 128 --fovy_range 20 20 --default_fovy 20 --guidance_scale 100 \
        --lambda_3d_normal_smooth 20 --dont_override_stuff --test_interval 10 \
        --default_radius 3.2 --radius_range 3.2 3.6 --optim adam --lr 0.0008 --dataset_size_train 360 \
        --progressive_view 
...
# python3.9 main.py -O --image /mnt/cache_sail/liulj/stable-dreamfusion/data/teddy_rgba.png \
#         --workspace dreamscene/teddy_phrase2_param2 --text "a brown teddy bear sitting on a ground" \
#         --iters 12500 --ckpt dreamscene/teddy_phrase1_param2/checkpoints/df_ep0100.pth --save_guidance --save_guidance_interval 1 \
